...
void Renderer::Init()
{
	...
	swapChainDesc.SampleDesc.Count = 8; // 16でエラーが出てしまう場合は8を代入
	...
	//depthStencilViewDesc.ViewDimension = D3D11_DSV_DIMENSION_TEXTURE2D; // アンチエイリアシングの設定のため変更
	...
	rasterizerDesc.CullMode = D3D11_CULL_BACK; // 背面カリングの設定 
	...
	samplerDesc.Filter = D3D11_FILTER_ANISOTROPIC; // 異方性フィルタリングに変更
